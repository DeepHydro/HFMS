...
namespace ESRI.ArcGIS.Samples
{
	...
	public class Editor
	{
		...
		private void vertexLayer_MouseLeave(object sender, Graphic graphic, MouseEventArgs args)
		{
			if (snapVertex != null)
			{
		...
		/// <param name="graphic">The graphic.</param>
		/// <param name="args">The <see cref="System.Windows.Input.MouseEventArgs"/> instance containing the event data.</param>
		private void vertexLayer_MouseMove(object sender, Graphic graphic, MouseEventArgs args)
		{
		...
		private void vertexLayer_MouseLeftButtonDown(object sender, Graphic graphic, MouseButtonEventArgs args)
		{
